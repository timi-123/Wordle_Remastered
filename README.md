...
Клучната логика за проверка и боење на погодок е издвоена во посебен статички сервис `GuessEvaluator`.
...
`LetterStatus` ги претставува трите можни состојби:

- `Correct` - точна буква на точна позиција
- `Present` - буквата постои, но е на друга позиција
- `Absent` - буквата ја нема

Методот `Evaluate` работи во две минувања за правилно да ги обработи повторените букви.

Методот `ColorFor` ја претвора состојбата во боја, а `ApplyToRow` ги ажурира и полињата и тастатурата.
